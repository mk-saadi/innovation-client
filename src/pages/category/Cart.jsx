												...
												{cartItems && (
													<>
														...
														<div className="mt-6">
															<Link
																to="/checkout"
																className="flex items-center justify-center px-6 py-3 text-base font-medium text-white duration-200 border border-transparent rounded-md shadow-md bg-amber-600 hover:bg-amber-700 active:scale-95"
																onClick={() => setOpen(false)}
															>
																Checkout
															</Link>
